...
function createBox(line, x, y, startAngle, speedX, speedY) {
	...
	return '<View width="30" height="30" border-radius="10%" left="'+x+'" top="'+y+'" background-color="rgba('+(line%255)+',122,0,0.7)"></View>';	
}
...
function createParticle(x, y, width, height, intensity) {
	...
	return '<View left="'+x+'" top="'+y+'" width="30" height="30" radial-gradient="white, rgba(255,255,255,0.1) 10% , white 30%, rgba(0,0,255,0.1)" border-radius="50%"></View>';
}
...
function processLine(line) {
	...
	var str = '<View width="100%" height="100hp" background-color="blue">'
			  +'<Image src="/static/ilves.png" width="100%" left="0" top="0" opacity="'+op1+'" height="100hp"/>'
			  +'<Image src="/static/s2.png" width="100%" left="0" top="0" opacity="'+op2+'" height="100hp"/>';

	str+=createPhone(line, line, imageStrip());

	for(var i=0; i<10; i++) {
		str+=createBox(line, i*20, i*20, i/10, 0.10, 0.12);
	}
